...
battle_la = Movie("Battle: Los Angeles",
                  "https://upload.wikimedia.org/wikipedia/en/2/29/Battle_Los_Angeles_Poster.jpg",  # noqa
                  "https://www.youtube.com/watch?v=9otTzrO9Bfw")

resident_evil = Movie("Resident Evil",
                      "http://www.gstatic.com/tv/thumb/movieposters/29625/p29625_p_v8_aa.jpg",  # noqa
                      "https://www.youtube.com/watch?v=o1Q68pbiEBI")

wreck_it_ralph = Movie("Wreck It Ralph",
                       "http://t3.gstatic.com/images?q=tbn:ANd9GcR6e2NEBAIaJQ8_-1KSrUc1NKuyBWAK0ch7DerecaEhYEow1dnL",  # noqa
                       "https://www.youtube.com/watch?v=87E6N7ToCxs")

meet_the_millers = Movie("Meet the Millers",
                         "http://t3.gstatic.com/images?q=tbn:ANd9GcT6xk5KWWVADWHUBeG1ZXTfW-Y2pMIbiHbcWMSb2Mrg_G06vG_e",  # noqa
                         "https://www.youtube.com/watch?v=0Vsy5KzsieQ")

# Stores Movie objects in a list/array to be used
# by the method fresh_tomatoes.open_movies_page
